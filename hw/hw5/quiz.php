    ...
    <div id='content'>
        ...
        <div id='header'>
            ...
            <form action="logout.php" id="logout">
                <button type="submit" form="logout" name="submitLogout" class="loginOut" id="logoutButton">Logout</button>
            </form>
            <div>
                <h3 class='score'></h3>
                <h3 class='allScore'></h3>
            </div>
        ...
        $(document).ready(function() {
            $('#submit').click(function() {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    url: "scoreApi.php?userId=" + <?php echo $_SESSION['userId']; ?>  + "&score=" + scorePercent,
                    dataType: "json",
                    data: { },
                    ...
                    console.log(data.quizzesTaken);
                    
                    $('.allScore').html('You have an average of ' + Math.round(data.avgScore) + '% from ' + data.quizzesTaken + ' quizzez taken.');
